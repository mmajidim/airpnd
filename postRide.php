 ...
 */
    ...
    $scriptFiles = array("site","common","liquidSlider","postRide");
    $airpnd->loadScripts($scriptFiles);
    $airpnd->loadMenu();
    $airpnd->loadContent('postRide');
    $airpnd->loadFooter();
/* End of file postRide.php */
/* Location: postRide.php */
?>
