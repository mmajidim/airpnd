 ...
 */
    ...
    $scriptFiles = array("site","common","liquidSlider","myLifts");
    $airpnd->loadScripts($scriptFiles);
    $airpnd->loadMenu();
    $airpnd->loadContent('myLifts');
    $airpnd->loadFooter();
/* End of file manageListing.php */
/* Location: manageListing.php */
?>
