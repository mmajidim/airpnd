        ...
        <div class="row-fluid">
            <div class="span10">
                <div class="container-fluid">
                    ...
                    <p>
                        <h5>
                            How do I plan pick-up and drop-off point?
                        </h5>
                    </p>
                    <p>
                        After confirming the ride, riders and drivers get in touch directly with each other to plan a pick up or drop off point
                    </p>
                    ...
                    <p>
                        You can post <a href="postRide.php"> Offer a Ride </a> on AirPnD and we will notify you when someone wants to contact you and request a ride. Alternatively, you can <a href="findRider.php"> Search for Riders</a>
                    </p>
                    <p>
                        <h5>
                    ...
                    <p>
                        <h5>
                            How do I search for driver?
                        </h5>
                    </p>
                    <p>
                        You can click on <a href="findRide.php"> Search for Drivers </a> to view available rides being offered
                    </p>
                    <p>
                        <h5>
                            How do I search for riders?
                        </h5>
                    </p>
                    <p>
                        You can click on <a href="findRider.php"> Search for Riders </a> to view available rides being requested    
                    </p>
                    <p>
                        <h5>
                            How do I get pay as a driver?
                        </h5>
                    </p>
                    <p>
                    ...
                    <p>
                        <h5>
                            How do I make payment to a driver?
                        </h5>
                    </p>
                    <p>
                        All payment is made online via AirPnD booking system by a credit card.
                    </p>
                    <p>
                        <h5>
                    ...
                    <p>
                        <h5>
                            How do I book a ride if I find a match?
                        </h5>
                    </p>
                    <p>
